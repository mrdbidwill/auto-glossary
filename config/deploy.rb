...
namespace :systemd_puma do
  ...
  task :install_service do
    on roles(:app) do
      execute :sudo, :cp, "#{release_path}/config/puma.service", "/etc/systemd/system/puma-auto-glossary.service"
      execute :sudo, :systemctl, "daemon-reload"
      execute :sudo, :systemctl, "enable", "puma-auto-glossary.service"
    end
  end
  ...
  task :start do
    on roles(:app) do
      execute :sudo, :systemctl, "start", "puma-auto-glossary.service"
    end
  end
  ...
  task :stop do
    on roles(:app) do
      execute :sudo, :systemctl, "stop", "puma-auto-glossary.service"
    end
  end
  ...
  task :restart do
    on roles(:app) do
      execute :sudo, :systemctl, "restart", "puma-auto-glossary.service"
    end
  end
  ...
  task :status do
    on roles(:app) do
      execute :sudo, :systemctl, "status", "puma-auto-glossary.service"
    end
  end
  ...
  task :logs do
    on roles(:app) do
      execute :sudo, :journalctl, "-xeu", "puma-auto-glossary.service", "--no-pager", "-n", "50"
    end
  end
